...
class Video:
    ...
    def get_video_start_frame_end_frame(self):
        ...
        video_info = UAV20L_gt_name_start_frame_end_frame[gt_name]
...
class UAV20L_DataSet:

    def __init__(self, UAV123_path):
        self.dataset_name = "UAV20L"
        self.UAV123_path = UAV123_path
        self.UAV20L_anno_path = self.UAV123_path+"/anno/UAV20L"
        self.UVA20L_video_path = self.UAV123_path+"/data_seq/UAV123"
    ...
    def get_data(self):
        self.videos = []
        gt_names = [f for f in os.listdir(self.UAV20L_anno_path) if f.endswith("txt")]
        '''
        ...
        for i in range(len(gt_names)):
            gt_path = self.UAV20L_anno_path + "/" + gt_names[i]
            video_name = ""
            ...
            video_path = self.UVA20L_video_path + "/" + video_name
            att_path = self.UAV20L_anno_path+"/att/"+gt_names[i]
