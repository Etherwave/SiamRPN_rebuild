...
import random
from data.utils.SiamRPN.Anchor import MyAnchors
from data.utils.SiamRPN.Augmentation import Augmentation
...
class Dataset_For_Dataloader(Dataset):
    def __init__(self, score_map_size=25):
        ...
        self.dataset_name = "Coco_Pre_10000"
    ...
    def get_datasets(self):
        ...
        elif self.dataset_name == "Coco_Pre_10000":
            dataset = Coco_DataSet(config[system_type].datasets.Coco_Dataset_Path, config[system_type].datasets.Coco_Pre_10000_Dataset_GT_Path)
        else:
    ...
    def get_negative_pair(self, index):
        ...
        while index >= len(self.categories[category2]):
            index -= len(self.annotations[category2])
            category2 += 1
            category2 %= len(self.annotations[category2])
