...
model_path = save_path+"/SiamRPNPP_epoch_190.pt"
# model_path = save_path+"/model.pth"

burn_in = 5

test_one_video_result_folder = config[system_type].project_path+"/test/SiamRPNPP/test_one_video_result"
...
def test_one_video(dataset_name, video_name):
    ...
    average_iou = iou_sum/len(video.frames)
    print(average_iou)
    # 0.5330552399338425
    # 0.6588014137423802
